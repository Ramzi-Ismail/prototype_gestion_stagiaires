...
namespace App.WinForm.Fileds
{
    public partial class ManyToOneField : App.WinFrom.Fileds.BaseField
    {
        ...
        public ManyToOneField(IBaseRepository Service, PropertyInfo propertyInfo, Control MainContainner, Orientation OrientationFiled, Size SizeLabel, Size SizeControl, Int64 DefaultFiltreValues)
          : this(Service,null, propertyInfo, MainContainner, OrientationFiled, SizeLabel, SizeControl, DefaultFiltreValues)
        {

        }

        public ManyToOneField() : this(null,null, null, Orientation.Horizontal, new Size(50, 20), new Size(50, 20), 0)
        {

        }

        private ManyToOneField(IBaseRepository Service, Type TypeObjet) : this(Service,TypeObjet, null,null, Orientation.Horizontal, new Size(50, 20), new Size(50, 20),0)
        {
