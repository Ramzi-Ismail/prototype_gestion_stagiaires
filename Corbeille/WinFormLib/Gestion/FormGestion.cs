...
{
    public partial class FormGestion<T>  : Form where T:BaseFormUC  
    {
        /// <summary>
        ...
        /// <summary>
        /// Créer d'un objet de type gestion des objets
        /// </summary>
        /// <param name="NomObjetPluriel">Le nom l'objet en pluriel</param>
        /// <param name="grideUC"></param>
        public FormGestion(string nomObjetPluriel, BaseGridUC grideUC)
        {
        ...
        {
             // Création de l'affichage des objets
